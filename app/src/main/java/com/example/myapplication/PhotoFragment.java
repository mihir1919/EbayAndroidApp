...
//        String url = "https://ebayreactmihir-2454971216.wl.r.appspot.com/getImages/iphone";
...
//                                        int imageHeightInPixels = 1000; // Adjust this value according to your preference
//
//                                        for (String imageUrl : imageUrls) {
//                                            ImageView imageView = new ImageView(view.getContext());
//                                            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
//                                                    LinearLayout.LayoutParams.MATCH_PARENT,
//                                                    imageHeightInPixels // Fixed height for the images
//                                            );
